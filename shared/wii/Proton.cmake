# Proton CMake Configuration for Wii
...
string(REPLACE "/shared/wii/Proton.cmake" "" PROTON_ROOT "${CMAKE_CURRENT_LIST_FILE}")

# Wii specific
set(PROTON_WII_OPENGX "${PROTON_ROOT}/shared/wii/opengx")

# convert to a DOL, should remove DWARF info and other unneeded crap
find_program(ELF2DOL elf2dol PATHS "$ENV{DEVKITPPC}/bin" REQUIRED)
...
add_definitions(-DBOOST_ALL_NO_LIB -DPLATFORM_WII)
...
endmacro(proton_wii_opengx)

# WII: Convert to DOL
macro(proton_convert_dol)
	set(FINAL_ELF "${CMAKE_HOME_DIRECTORY}/../bin/${PROJECT_NAME}")
	add_custom_command(
		TARGET ${PROJECT_NAME} POST_BUILD
		COMMAND ${ELF2DOL} ${FINAL_ELF} ${FINAL_ELF}.dol
