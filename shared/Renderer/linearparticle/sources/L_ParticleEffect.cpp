...
#if !defined(C_GL_MODE) &&  !defined( ANDROID_NDK) && !defined( PLATFORM_BBX) && !defined( RT_WEBOS) && !defined( RT_GLES_ADAPTOR_MODE) && !defined( PLATFORM_PSP2) && !defined(PLATFORM_WII)
